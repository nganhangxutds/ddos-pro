...
if(cluster.isMaster){
	...
	console.clear();
	console.log("Made by @scrvipbytrugzacker <3".red);
console.log("Attack Details [?]: ".yellow);
console.log("-------------------".blue);
console.log("-  Status: ".white + "[+ Attack Successfully Sent]".rainbow);
console.log("-  Target: ".white + "[+" + process.argv[2].rainbow + "]");
console.log("-  Theard: ".white + "[+" + process.argv[5].rainbow + "]");
console.log("-  Time: ".white + "[+" + process.argv[3].rainbow + "]");
console.log("-  Rate: ".white + "[+" + process.argv[4].rainbow + "]");
console.log("-  Method: ".white + "[+" + process.argv[6].rainbow + "]");
console.log(`ProxyFile: ${args.proxyFile} | Total: ${proxies.length}`.yellow);
console.log("---------------------------------------------------------".white);
console.log(`[!]Note:`.red + "SUPER FLOOD V2.5.|".white);
console.log("---------------------------------------------------------".white);
}else{
